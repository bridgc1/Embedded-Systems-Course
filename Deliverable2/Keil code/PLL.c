...
//Last updated by Christina Bridges on March 5, 2026 (changed PLL SYSCLK parameters)
...
#define Q            0
#define N           4  // chosen for reference frequency within 4 to 30 MHz   14 FOR ME
#define MINT        96  // 480,000,000 = (25,000,000/(0 + 1)/(4 + 1))*(96 + (0/1,024))     13 FOR ME
#define MFRAC        0  // zero to reduce jitter
  //    SysClk = fVCO / (PSYSDIV + 1) // fVCO needs to be sufficiently high i.e. for proper working of memory timing table that depends on it
